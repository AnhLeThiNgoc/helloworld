...
class Issue extends DevYiiActiveRecord 
{
    ...
    public static function getAllowedStatusRange() {
        return array( self::STATUS_NOTYET,
            self::STATUS_YET,
            self::STATUS_FINAL, );
    }
	...
	public function relations()
	{
		...
		return array(
            ...
            'users'=>array(self::MANY_MANY ,'User','tbl_project_user_assignment(project _id,user_id)'),
		);
	}
...
//		$criteria->compare('update_user_id',$this->update_user_id);
    ...
    public function getStatusText()
    {
        ...
        return isset($statusOptions[$this->status_id]) 
            ? $statusOptions[$this->status_id] : "unknown status ($this->status_ id)";
    }
    /**
